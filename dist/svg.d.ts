...
declare namespace Canvas {
    class Brushes {
        ...
        */
         ...
         * Night (#0C090A)
        */
        static readonly Night: Color;
        /**
         * Gunmetal (#2C3539)
        */
        static readonly Gunmetal: Color;
        /**
         * Midnight (#2B1B17)
        */
        static readonly Midnight: Color;
        /**
         * Charcoal (#34282C)
        */
        ...
        */
         ...
         * Oil (#3B3131)
        */
        static readonly Oil: Color;
        /**
         * Black Cat (#413839)
        */
        static readonly BlackCat: Color;
        /**
         * Iridium (#3D3C3A)
        */
        static readonly Iridium: Color;
        /**
         * Black Eel (#463E3F)
        */
        static readonly BlackEel: Color;
        /**
         * Black Cow (#4C4646)
        */
        static readonly BlackCow: Color;
        /**
         * Gray Wolf (#504A4B)
        */
        static readonly GrayWolf: Color;
        /**
         * Vampire Gray (#565051)
        */
        static readonly VampireGray: Color;
        /**
         * Gray Dolphin (#5C5858)
        */
        static readonly GrayDolphin: Color;
        /**
         * Carbon Gray (#625D5D)
        */
        static readonly CarbonGray: Color;
        /**
         * Ash Gray (#666362)
        */
        static readonly AshGray: Color;
        /**
         * Cloudy Gray (#6D6968)
        */
        static readonly CloudyGray: Color;
        /**
         * Smokey Gray (#726E6D)
        */
        static readonly SmokeyGray: Color;
        /**
         * Gray (#736F6E)
        */
         ...
         * Granite (#837E7C)
        */
        static readonly Granite: Color;
        /**
         * Battleship Gray (#848482)
        */
        static readonly BattleshipGray: Color;
        /**
         * Gray Cloud (#B6B6B4)
        */
        static readonly GrayCloud: Color;
        /**
         * Gray Goose (#D1D0CE)
        */
        static readonly GrayGoose: Color;
        /**
         * Platinum (#E5E4E2)
        */
        ...
        */
        static readonly MetallicSilver: Color;
        /**
         * Blue Gray (#98AFC7)
        */
        ...
        */
         ...
         * Jet Gray (#616D7E)
        */
        static readonly JetGray: Color;
        /**
         * Mist Blue (#646D7E)
        */
        static readonly MistBlue: Color;
        /**
         * Marble Blue (#566D7E)
        */
        static readonly MarbleBlue: Color;
        /**
         * Slate Blue (#737CA1)
        */
        ...
        */
         ...
         * Blue Whale (#342D7E)
        */
        static readonly BlueWhale: Color;
        /**
         * Lapis Blue (#15317E)
        */
        static readonly LapisBlue: Color;
        /**
         * Denim Dark Blue (#151B8D)
        */
        static readonly DenimDarkBlue: Color;
        /**
         * Earth Blue (#0000A0)
        */
        static readonly EarthBlue: Color;
        /**
         * Cobalt Blue (#0020C2)
        */
        static readonly CobaltBlue: Color;
        /**
         * Blueberry Blue (#0041C2)
        */
        static readonly BlueberryBlue: Color;
        /**
        ...
        */
         ...
         * Blue Eyes (#1569C7)
        */
        static readonly BlueEyes: Color;
        /**
         * Royal Blue (#2B60DE)
        */
         ...
         * Blue Orchid (#1F45FC)
        */
        static readonly BlueOrchid: Color;
        /**
         * Blue Lotus (#6960EC)
        */
        static readonly BlueLotus: Color;
        /**
         * Light Slate Blue (#736AFF)
        */
        static readonly LightSlateBlue: Color;
        /**
         * Windows Blue (#357EC7)
        */
        static readonly WindowsBlue: Color;
        /**
         * Glacial Blue Ice (#368BC1)
        */
        static readonly GlacialBlueIce: Color;
        /**
         * Silk Blue (#488AC7)
        */
        static readonly SilkBlue: Color;
        /**
         * Blue Ivy (#3090C7)
        */
        static readonly BlueIvy: Color;
        /**
         * Blue Koi (#659EC7)
        */
        static readonly BlueKoi: Color;
        /**
        ...
        */
         ...
         * Blue Ribbon (#306EFF)
        */
        static readonly BlueRibbon: Color;
        /**
         * Blue Dress (#157DEC)
        */
        static readonly BlueDress: Color;
        /**
         * Dodger Blue (#1589FF)
        */
        ...
        */
        static readonly ButterflyBlue: Color;
        /**
         * Iceberg (#56A5EC)
        */
         ...
         * Crystal Blue (#5CB3FF)
        */
        static readonly CrystalBlue: Color;
        /**
        ...
        */
         ...
         * Denim Blue (#79BAEC)
        */
        static readonly DenimBlue: Color;
        /**
        ...
        */
         ...
         * Day Sky Blue (#82CAFF)
        */
        static readonly DaySkyBlue: Color;
        /**
         * Jeans Blue (#A0CFEC)
        */
        static readonly JeansBlue: Color;
        /**
         * Blue Angel (#B7CEEC)
        */
        static readonly BlueAngel: Color;
        /**
         * Pastel Blue (#B4CFEC)
        */
        ...
        */
         ...
         * Coral Blue (#AFDCEC)
        */
        static readonly CoralBlue: Color;
        /**
         * Light Blue (#ADDFFF)
        */
        ...
        */
        static readonly PaleBlueLily: Color;
        /**
         * Light Cyan (#E0FFFF)
        */
        ...
        */
         ...
         * Light Slate (#CCFFFF)
        */
        static readonly LightSlate: Color;
        /**
         * Light Aquamarine (#93FFE8)
        */
        static readonly LightAquamarine: Color;
        /**
        ...
        */
         ...
         * Cyan or Aqua (#00FFFF)
        */
        static readonly CyanorAqua: Color;
        /**
         * Tron Blue (#7DFDFE)
        */
        static readonly TronBlue: Color;
        /**
         * Blue Zircon (#57FEFF)
        */
        static readonly BlueZircon: Color;
        /**
         * Blue Lagoon (#8EEBEC)
        */
        static readonly BlueLagoon: Color;
        /**
         * Celeste (#50EBEC)
        */
        static readonly Celeste: Color;
        /**
         * Blue Diamond (#4EE2EC)
        */
        static readonly BlueDiamond: Color;
        /**
         * Tiffany Blue (#81D8D0)
        */
         ...
         * Cyan Opaque (#92C7C7)
        */
        static readonly CyanOpaque: Color;
        /**
         * Blue Hosta (#77BFC7)
        */
        static readonly BlueHosta: Color;
        /**
         * Northern Lights Blue (#78C7C7)
        */
        static readonly NorthernLightsBlue: Color;
        /**
        ...
        */
         ...
         * Jellyfish (#46C7C7)
        */
        static readonly Jellyfish: Color;
        /**
         * Blue green (#7BCCB5)
        */
        ...
        */
        static readonly MacawBlueGreen: Color;
        /**
        ...
        */
        static readonly SeaTurtleGreen: Color;
        /**
        ...
        */
        static readonly GreenishBlue: Color;
        /**
         * Grayish Turquoise (#5E7D7E)
        */
        static readonly GrayishTurquoise: Color;
        /**
         * Beetle Green (#4C787E)
        */
        static readonly BeetleGreen: Color;
        /**
         * Teal (#008080)
        */
        ...
        */
         ...
         * Sage Green (#848b79)
        */
        static readonly SageGreen: Color;
        /**
         * Hazel Green (#617C58)
        */
        static readonly HazelGreen: Color;
        /**
         * Venom Green (#728C00)
        */
        static readonly VenomGreen: Color;
        /**
         * Fern Green (#667C26)
        */
        ...
        */
        static readonly DarkForestGreen: Color;
        /**
        ...
        */
        static readonly MediumForestGreen: Color;
        /**
         * Seaweed Green (#437C17)
        */
        static readonly SeaweedGreen: Color;
        /**
         * Pine Green (#387C44)
        */
        ...
        */
         ...
         * Green Onion (#6AA121)
        */
        static readonly GreenOnion: Color;
        /**
         * Spring Green (#4AA02C)
        */
        ...
        */
         ...
         * Clover Green (#3EA055)
        */
        static readonly CloverGreen: Color;
        /**
         * Green Snake (#6CBB3C)
        */
        static readonly GreenSnake: Color;
        /**
         * Alien Green (#6CC417)
        */
        static readonly AlienGreen: Color;
        /**
         * Green Apple (#4CC417)
        */
        static readonly GreenApple: Color;
        /**
         * Yellow Green (#52D017)
        */
        ...
        */
         ...
         * Zombie Green (#54C571)
        */
        static readonly ZombieGreen: Color;
        /**
         * Frog Green (#99C68E)
        */
        static readonly FrogGreen: Color;
        /**
         * Green Peas (#89C35C)
        */
        static readonly GreenPeas: Color;
        /**
         * Dollar Bill Green (#85BB65)
        */
        static readonly DollarBillGreen: Color;
        /**
        ...
        */
         ...
         * Iguana Green (#9CB071)
        */
        static readonly IguanaGreen: Color;
        /**
         * Avocado Green (#B2C248)
        */
        static readonly AvocadoGreen: Color;
        /**
         * Pistachio Green (#9DC209)
        */
        static readonly PistachioGreen: Color;
        /**
         * Salad Green (#A1C935)
        */
        static readonly SaladGreen: Color;
        /**
         * Hummingbird Green (#7FE817)
        */
        static readonly HummingbirdGreen: Color;
        /**
         * Nebula Green (#59E817)
        */
        static readonly NebulaGreen: Color;
        /**
         * Stoplight Go Green (#57E964)
        */
        static readonly StoplightGoGreen: Color;
        /**
         * Algae Green (#64E986)
        */
        static readonly AlgaeGreen: Color;
        /**
         * Jade Green (#5EFB6E)
        */
        static readonly JadeGreen: Color;
        /**
         * Green (#00FF00)
        */
        ...
        */
        static readonly EmeraldGreen: Color;
        /**
         * Lawn Green (#87F717)
        */
        ...
        */
         ...
         * Dragon Green (#6AFB92)
        */
        static readonly DragonGreen: Color;
        /**
         * Mint green (#98FF98)
        */
         ...
         * Green Thumb (#B5EAAA)
        */
        static readonly GreenThumb: Color;
        /**
         * Light Jade (#C3FDB8)
        */
        static readonly LightJade: Color;
        /**
         * Tea Green (#CCFB5D)
        */
        ...
        */
         ...
         * Slime Green (#BCE954)
        */
        static readonly SlimeGreen: Color;
        /**
         * Goldenrod (#EDDA74)
        */
        ...
        */
         ...
         * Sun Yellow (#FFE87C)
        */
        static readonly SunYellow: Color;
        /**
         * Yellow (#FFFF00)
        */
         ...
         * Corn Yellow (#FFF380)
        */
        static readonly CornYellow: Color;
        /**
         * Parchment (#FFFFC2)
        */
        static readonly Parchment: Color;
        /**
         * Cream (#FFFFCC)
        */
        ...
        */
         ...
         * Tan Brown (#ECE5B6)
        */
        static readonly TanBrown: Color;
        /**
         * Peach (#FFE5B4)
        */
        ...
        */
        static readonly RubberDuckyYellow: Color;
        /**
         * Bright Gold (#FDD017)
        */
        static readonly BrightGold: Color;
        /**
         * Golden brown (#EAC117)
        */
        ...
        */
        static readonly MacaroniandCheese: Color;
        /**
         * Saffron (#FBB917)
        */
         ...
         * Beer (#FBB117)
        */
        static readonly Beer: Color;
        /**
         * Cantaloupe (#FFA62F)
        */
        static readonly Cantaloupe: Color;
        /**
         * Bee Yellow (#E9AB17)
        */
        static readonly BeeYellow: Color;
        /**
         * Brown Sugar (#E2A76F)
        */
        static readonly BrownSugar: Color;
        /**
         * BurlyWood (#DEB887)
        */
        ...
        */
         ...
         * Ginger Brown (#C9BE62)
        */
        static readonly GingerBrown: Color;
        /**
        ...
        */
        static readonly FallLeafBrown: Color;
        /**
         * Orange Gold (#D4A017)
        */
        static readonly OrangeGold: Color;
        /**
         * Sand (#C2B280)
        */
         ...
         * Cookie Brown (#C7A317)
        */
        static readonly CookieBrown: Color;
        /**
         * Caramel (#C68E17)
        */
        static readonly Caramel: Color;
        /**
         * Brass (#B5A642)
        */
        ...
        */
         ...
         * Camel brown (#C19A6B)
        */
        static readonly Camelbrown: Color;
        /**
         * Bronze (#CD7F32)
        */
         ...
         * Tiger Orange (#C88141)
        */
        static readonly TigerOrange: Color;
        /**
         * Cinnamon (#C58917)
        */
         ...
         * Bullet Shell (#AF9B60)
        */
        static readonly BulletShell: Color;
        /**
        ...
        */
         ...
         * Wood (#966F33)
        */
        static readonly Wood: Color;
        /**
         * Oak Brown (#806517)
        */
        static readonly OakBrown: Color;
        /**
         * Moccasin (#827839)
        */
         ...
         * Army Brown (#827B60)
        */
        static readonly ArmyBrown: Color;
        /**
         * Sandstone (#786D5F)
        */
        static readonly Sandstone: Color;
        /**
         * Mocha (#493D26)
        */
        static readonly Mocha: Color;
        /**
         * Taupe (#483C32)
        */
        ...
        */
         ...
         * Brown Bear (#835C3B)
        */
        static readonly BrownBear: Color;
        /**
         * Red Dirt (#7F5217)
        */
        static readonly RedDirt: Color;
        /**
         * Sepia (#7F462C)
        */
        ...
        */
        static readonly OrangeSalmon: Color;
        /**
         * Rust (#C36241)
        */
        ...
        */
         ...
         * Sedona (#CC6600)
        */
        static readonly Sedona: Color;
        /**
         * Papaya Orange (#E56717)
        */
        static readonly PapayaOrange: Color;
        /**
         * Halloween Orange (#E66C2C)
        */
        static readonly HalloweenOrange: Color;
        /**
         * Pumpkin Orange (#F87217)
        */
        static readonly PumpkinOrange: Color;
        /**
         * Construction Cone Orange (#F87431)
        */
        static readonly ConstructionConeOrange: Color;
        /**
         * Sunrise Orange (#E67451)
        */
        static readonly SunriseOrange: Color;
        /**
         * Mango Orange (#FF8040)
        */
        static readonly MangoOrange: Color;
        /**
         * Dark Orange (#F88017)
        */
        ...
        */
        static readonly BasketBallOrange: Color;
        /**
         * Light Salmon (#F9966B)
        */
        ...
        */
         ...
         * Bean Red (#F75D59)
        */
        static readonly BeanRed: Color;
        /**
         * Valentine Red (#E55451)
        */
        static readonly ValentineRed: Color;
        /**
         * Shocking Orange (#E55B3C)
        */
        static readonly ShockingOrange: Color;
        /**
         * Red (#FF0000)
        */
        ...
        */
         ...
         * Lava Red (#E42217)
        */
        static readonly LavaRed: Color;
        /**
         * Love Red (#E41B17)
        */
        static readonly LoveRed: Color;
        /**
         * Grapefruit (#DC381F)
        */
        static readonly Grapefruit: Color;
        /**
         * Chestnut Red (#C34A2C)
        */
        static readonly ChestnutRed: Color;
        /**
         * Cherry Red (#C24641)
        */
        static readonly CherryRed: Color;
        /**
         * Mahogany (#C04000)
        */
        ...
        */
        static readonly ChilliPepper: Color;
        /**
         * Cranberry (#9F000F)
        */
        static readonly Cranberry: Color;
        /**
         * Red Wine (#990012)
        */
        static readonly RedWine: Color;
        /**
         * Burgundy (#8C001A)
        */
        ...
        */
         ...
         * Blood Red (#7E3517)
        */
        static readonly BloodRed: Color;
        /**
         * Sienna (#8A4117)
        */
        ...
        */
         ...
         * Plum Pie (#7D0541)
        */
        static readonly PlumPie: Color;
        /**
         * Velvet Maroon (#7E354D)
        */
        static readonly VelvetMaroon: Color;
        /**
         * Plum Velvet (#7D0552)
        */
        static readonly PlumVelvet: Color;
        /**
         * Rosy Finch (#7F4E52)
        */
        static readonly RosyFinch: Color;
        /**
         * Puce (#7F5A58)
        */
         ...
         * Dull Purple (#7F525D)
        */
        static readonly DullPurple: Color;
        /**
         * Rosy Brown (#B38481)
        */
         ...
         * Khaki Rose (#C5908E)
        */
        static readonly KhakiRose: Color;
        /**
         * Pink Bow (#C48189)
        */
        static readonly PinkBow: Color;
        /**
         * Lipstick Pink (#C48793)
        */
        static readonly LipstickPink: Color;
        /**
         * Rose (#E8ADAA)
        */
        ...
        */
        static readonly PinkBubbleGum: Color;
        /**
         * Misty Rose (#FBBBB9)
        */
        ...
        */
         ...
         * Pink Rose (#E7A1B0)
        */
        static readonly PinkRose: Color;
        /**
         * Pink Daisy (#E799A3)
        */
        static readonly PinkDaisy: Color;
        /**
         * Cadillac Pink (#E38AAE)
        */
        static readonly CadillacPink: Color;
        /**
        ...
        */
         ...
         * Blush Red (#E56E94)
        */
        static readonly BlushRed: Color;
        /**
         * Hot Pink (#F660AB)
        */
        ...
        */
        static readonly WatermelonPink: Color;
        /**
         * Violet Red (#F6358A)
        */
        static readonly VioletRed: Color;
        /**
         * Deep Pink (#F52887)
        */
         ...
         * Pink Cupcake (#E45E9D)
        */
        static readonly PinkCupcake: Color;
        /**
         * Pink Lemonade (#E4287C)
        */
        static readonly PinkLemonade: Color;
        /**
         * Neon Pink (#F535AA)
        */
        static readonly NeonPink: Color;
        /**
         * Magenta (#FF00FF)
        */
        ...
        */
        static readonly DimorphothecaMagenta: Color;
        /**
         * Bright Neon Pink (#F433FF)
        */
        static readonly BrightNeonPink: Color;
        /**
        ...
        */
         ...
         * Tulip Pink (#C25A7C)
        */
        static readonly TulipPink: Color;
        /**
        ...
        */
         ...
         * Rogue Pink (#C12869)
        */
        static readonly RoguePink: Color;
        /**
         * Burnt Pink (#C12267)
        */
        static readonly BurntPink: Color;
        /**
         * Bashful Pink (#C25283)
        */
        static readonly BashfulPink: Color;
        /**
         * Dark Carnation Pink (#C12283)
        */
        static readonly DarkCarnationPink: Color;
        /**
         * Plum (#B93B8F)
        */
         ...
         * Viola Purple (#7E587E)
        */
        static readonly ViolaPurple: Color;
        /**
         * Purple Iris (#571B7E)
        */
        static readonly PurpleIris: Color;
        /**
         * Plum Purple (#583759)
        */
        static readonly PlumPurple: Color;
        /**
         * Indigo (#4B0082)
        */
        ...
        */
        static readonly PurpleMonster: Color;
        /**
         * Purple Haze (#4E387E)
        */
        static readonly PurpleHaze: Color;
        /**
         * Eggplant (#614051)
        */
         ...
         * Grape (#5E5A80)
        */
        static readonly Grape: Color;
        /**
         * Purple Jam (#6A287E)
        */
        static readonly PurpleJam: Color;
        /**
         * Dark Orchid (#7D1B7E)
        */
        ...
        */
        static readonly PurpleFlower: Color;
        /**
        ...
        */
        static readonly PurpleAmethyst: Color;
        /**
         * Dark Violet (#842DCE)
        */
        ...
        */
        static readonly PurpleSageBush: Color;
        /**
         * Lovely Purple (#7F38EC)
        */
        static readonly LovelyPurple: Color;
        /**
         * Purple (#8E35EF)
        */
        ...
        */
        static readonly AztechPurple: Color;
        /**
        ...
        */
        static readonly JasminePurple: Color;
        /**
         * Purple Daffodil (#B041FF)
        */
        static readonly PurpleDaffodil: Color;
        /**
        ...
        */
        static readonly CrocusPurple: Color;
        /**
         * Purple Mimosa (#9E7BFF)
        */
        static readonly PurpleMimosa: Color;
        /**
         * Heliotrope Purple (#D462FF)
        */
        static readonly HeliotropePurple: Color;
        /**
         * Crimson (#E238EC)
        */
        ...
        */
        static readonly PurpleDragon: Color;
        /**
         * Lilac (#C8A2C8)
        */
         ...
         * Blush Pink (#E6A9EC)
        */
        static readonly BlushPink: Color;
        /**
         * Mauve (#E0B0FF)
        */
        ...
        */
        static readonly WisteriaPurple: Color;
        /**
         * Blossom Pink (#F9B7FF)
        */
        static readonly BlossomPink: Color;
        /**
         * Thistle (#D2B9D3)
        */
        ...
        */
        static readonly LavenderPinocchio: Color;
        /**
        ...
        */
         ...
         * Milk White (#FEFCFF)
        */
        static readonly MilkWhite: Color;
        /**
         * White (#FFFFFF)
        */
